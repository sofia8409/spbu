...
<html lang="en">
	<head>
		<title>Warga UTeM | Borang Permohonan</title
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Borang Permohonan</h5>
												</div>
	...
	if(isset ($_POST['apply']))
		{
			...
			$booking = mysqli_query ($con, "insert into application (user_id, state_id, start_date, start_time, end_date, end_time, total_participan, purpose, status, location, jawatan, jabatan) values 
																	('".$id."', '".$state_id."','".$tarikhpergi."','".$masapergi."','".$tarikhbalik."', '".$masabalik."' ,'".$bil_peserta."', '".$tujuan."', 'MENUNGGU PENGESAHAN', '".$lokasi."', '".$jawatan."' ,'".$jabatan."')");
			if ($booking==TRUE)
			{
				echo "<script type='text/javascript'>alert('Berjaya untuk Menempah')</script>";
				echo "<meta http-equiv='refresh' content='0;URL=senarai-permohonanWU.php'";
			}
			else
			{
