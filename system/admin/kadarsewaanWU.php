...
<html lang="en">
	<head>
		<title>	Admin | Kadar Sewaan Warga UTeM</title>
...
<?php include('include/sidebar.php');?>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">	Admin | Kadar Sewaan Warga UTeM </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Kadar Sewaan Warga UTeM </span>
									</li>
								</ol>
							</div>
						</section>
    ...
    <tr>
      ...
      <tr>
        <td><strong>MINYAK</strong></div>
		<div align="left">
        <label for="C.T2"></label>
            <input type="text" name="toi" id="toi" value="<?php echo $row['total_oil'];?> " readonly/>
          </div></td>
      </tr></br>
        <div class="form-group">
    <div align="left">
		...
		if ($query==TRUE)
		{
			...
			if($jumlahpemandu==1)
			{
				...
				?>
                    ...
                    <form method="post" action="borang-permohonanWU.php">
			...
			else
			{
				...
				?>
                    ...
                    <form method="post" action="borang-permohonanWU.php">
                        <input type="submit" name="mohon" id="jumlah" value="mohon"  align="right"/>
                        <input type="text" name="negeriID" id="negeri ID" value="<?php echo $id;?> " hidden/>
                    </form>
                    </td>
                    </table>
