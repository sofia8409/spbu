...
<html lang="en">
	<head>
		<title>Admin | Senarai Harga Pihak Luar</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Senarai Harga Pihak Luar</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Senarai Harga Pihak Luar</span>
									</li>
								</ol>
							</div>
						</section>
...
?>
     <tr>
	  ...
	  <td><div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="kadarsewaanPL.php?id=<?php echo $row['state_id']; ?>">
