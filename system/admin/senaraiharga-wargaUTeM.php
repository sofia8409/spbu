...
<html lang="en">
	<head>
		<title>Admin| Senarai Harga Warga UTeM</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Senarai Harga Warga UTeM</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Senarai Harga Warga UTeM</span>
									</li>
								</ol>
							</div>
						</section>
    ...
    <tr>
      ...
      <td><?php echo $row['total_per_day']; ?></td>
       <td><div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="kadarsewaanWU.php?id=<?php echo $row['state_id']; ?>">
